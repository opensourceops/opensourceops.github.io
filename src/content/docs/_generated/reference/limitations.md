...
documentation build. The [execution ledger](https://github.com/opensourceops/agentctl/blob/main/docs/execution/AUTONOMOUS_LAUNCH_READINESS.md)
...
- The DevOps catalog labels deterministic/fake-provider workflows, isolated
  ...
  production deployment coverage. See the [suite catalog](https://github.com/opensourceops/agentctl/blob/main/examples/devops/catalog.json)
  and its [validation evidence](https://github.com/opensourceops/agentctl/blob/main/examples/devops/validation.json).
