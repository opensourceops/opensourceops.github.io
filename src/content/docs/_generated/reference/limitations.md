...
editUrl: "https://github.com/opensourceops/agentctl/edit/ed604369fb73a3d1bba65d8a2026927f59b14e97/docs/LIMITATIONS.md"
---
...
- Anthropic, Google, Azure OpenAI, MCP, and A2A have native adapters and mock
  ...
  services. The [retained GPT-5.6 matrix](https://github.com/opensourceops/agentctl/blob/ed604369fb73a3d1bba65d8a2026927f59b14e97/docs/execution/LIVE_FRAMEWORK_VERIFICATION.md)
...
- The DevOps catalog labels deterministic/fake-provider workflows, isolated
  ...
  production deployment coverage. See the [suite catalog](https://github.com/opensourceops/agentctl/blob/ed604369fb73a3d1bba65d8a2026927f59b14e97/examples/devops/catalog.json)
  and its [validation evidence](https://github.com/opensourceops/agentctl/blob/ed604369fb73a3d1bba65d8a2026927f59b14e97/examples/devops/validation.json).
