...
bytes are bounded. See [Network policy](https://github.com/opensourceops/agentctl/blob/main/docs/guides/NETWORK_POLICY.md).
...
isolation](https://github.com/opensourceops/agentctl/blob/main/docs/guides/PROCESS_ISOLATION.md) and [Secret
references](https://github.com/opensourceops/agentctl/blob/main/docs/guides/SECRET_REFERENCES.md).
...
> Canonical source: [`docs/policies.md`](https://github.com/opensourceops/agentctl/blob/main/docs/policies.md). Verified against agentctl commit `21e919da592b426992df76be37c892b70d073f9e`.
