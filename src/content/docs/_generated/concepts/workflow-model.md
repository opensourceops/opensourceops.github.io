...
durably skipped. See [Conditions and routers](https://github.com/opensourceops/agentctl/blob/main/docs/guides/CONDITIONS_AND_ROUTERS.md).
...
trace, or inspection output. See [Secret references](https://github.com/opensourceops/agentctl/blob/main/docs/guides/SECRET_REFERENCES.md).
...
select the visible child IDs. See [Matrix and foreach tasks](https://github.com/opensourceops/agentctl/blob/main/docs/guides/MATRIX_AND_FOREACH.md).
...
loops](https://github.com/opensourceops/agentctl/blob/main/docs/guides/BOUNDED_LOOPS.md).
...
[Reusable sub-workflows](https://github.com/opensourceops/agentctl/blob/main/docs/guides/SUB_WORKFLOWS.md).
...
[Compensate applied effects](https://github.com/opensourceops/agentctl/blob/main/docs/guides/COMPENSATION.md).
...
See [Structured role handoffs](https://github.com/opensourceops/agentctl/blob/main/docs/guides/STRUCTURED_HANDOFFS.md).
...
isolation](https://github.com/opensourceops/agentctl/blob/main/docs/guides/PROCESS_ISOLATION.md).
...
budgets](https://github.com/opensourceops/agentctl/blob/main/docs/guides/RESOURCE_BUDGETS.md).
...
> Canonical source: [`docs/DSL.md`](https://github.com/opensourceops/agentctl/blob/main/docs/DSL.md). Verified against agentctl commit `1e2a8b3437edf5f2e6dac3c29e14616ee20b619f`.
