...
> Canonical source: [`docs/MCP.md`](https://github.com/opensourceops/agentctl/blob/main/docs/MCP.md). Verified against agentctl commit `a1ebcadcc2557136cb82633862c50854223981fa`.
