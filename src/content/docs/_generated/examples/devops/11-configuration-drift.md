...
editUrl: "https://github.com/opensourceops/agentctl/edit/45d0995345ba048d8a8368466f56c388cc8cb992/examples/devops/11-configuration-drift/README.md"
---
> **Candidate example package:** [Download all files](/agentctl/downloads/devops/11-configuration-drift.zip). Built from source [`45d0995345ba`](https://github.com/opensourceops/agentctl/tree/45d0995345ba048d8a8368466f56c388cc8cb992/examples/devops/11-configuration-drift). It includes the helper and setup step used below; download the complete package before editing a workflow.
