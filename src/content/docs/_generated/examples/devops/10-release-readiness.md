...
editUrl: "https://github.com/opensourceops/agentctl/edit/0d4542cccdbd22cb96e3dec25cdffb66d0938ced/examples/devops/10-release-readiness/README.md"
---
> **Complete example package:** [Download all files](/agentctl/downloads/devops/10-release-readiness.zip). Built from source [`0d4542cccdbd`](https://github.com/opensourceops/agentctl/tree/0d4542cccdbd22cb96e3dec25cdffb66d0938ced/examples/devops/10-release-readiness). It includes the helper and setup step used below; download the complete package before editing a workflow.
