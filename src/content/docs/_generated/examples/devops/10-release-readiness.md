...
editUrl: "https://github.com/opensourceops/agentctl/edit/bb8fb0a5a28d876fee26c49c49a8a5bf1c8390e2/examples/devops/10-release-readiness/README.md"
---
> **Complete example package:** [Download all files](/agentctl/downloads/devops/10-release-readiness.zip). Built from source [`bb8fb0a5a28d`](https://github.com/opensourceops/agentctl/tree/bb8fb0a5a28d876fee26c49c49a8a5bf1c8390e2/examples/devops/10-release-readiness). It includes the helper and setup step used below; download the complete package before editing a workflow.
