...
editUrl: "https://github.com/opensourceops/agentctl/edit/0d4542cccdbd22cb96e3dec25cdffb66d0938ced/examples/devops/14-local-deployment/README.md"
---
> **Complete example package:** [Download all files](/agentctl/downloads/devops/14-local-deployment.zip). Built from source [`0d4542cccdbd`](https://github.com/opensourceops/agentctl/tree/0d4542cccdbd22cb96e3dec25cdffb66d0938ced/examples/devops/14-local-deployment). It includes the helper and setup step used below; download the complete package before editing a workflow.
