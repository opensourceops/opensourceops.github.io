...
editUrl: "https://github.com/opensourceops/agentctl/edit/0d4542cccdbd22cb96e3dec25cdffb66d0938ced/examples/devops/09-release-notes/README.md"
---
> **Complete example package:** [Download all files](/agentctl/downloads/devops/09-release-notes.zip). Built from source [`0d4542cccdbd`](https://github.com/opensourceops/agentctl/tree/0d4542cccdbd22cb96e3dec25cdffb66d0938ced/examples/devops/09-release-notes). It includes the helper and setup step used below; download the complete package before editing a workflow.
